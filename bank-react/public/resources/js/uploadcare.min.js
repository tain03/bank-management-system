...
!(function (e, t) {
  ...
  var w = function () {
    ...
    x = Object.freeze({ __proto__: null, isWindowDefined: w });
  w() &&
  ...
  var k = w() && !!(window.File && window.FileList && window.FileReader),
    z = w() && !(!window.FormData || !k),
    A =
      w() &&
      (function () {
        var e;
    ...
    S = k && A,
    F = null,
    T = w() && /^[^(]+\(iP(?:hone|od|ad);\s*(.+?)\)/.exec(navigator.userAgent);
  if (T) {
    var j = /OS (\d)_(\d)/.exec(T[1]);
    j && (F = +j[1] + j[2] / 10);
  }
  var D = !1;
  try {
    w() && new window.Blob() && (D = window.Blob);
  } catch (e) {}
  var I,
    P,
    M,
    ...
    X,
    J,
    Z = w() && (window.URL || window.webkitURL || !1),
    Q = Z && Z.createObjectURL && Z,
    $ =
      w() &&
    ...
    ie = {},
    ne = function (e) {
      if (null == ie[e]) return (ie[e] = !0), ae(e);
    },
    re = [].indexOf,
    oe = function (e) {
      var t, a, i, n;
      for (n = [], a = 0, i = e.length; a < i; a++)
        (t = e[a]), re.call(n, t) < 0 && n.push(t);
      return n;
    },
    le = function (e) {
    ...
    de = function (t, a, i, n) {
      ...
      return (
        ...
        t.then(r(a, o.resolve), r(i, o.reject), r(n, o.notify)),
        o.promise()
      );
    },
    pe = function (t, a) {
    ...
    ge = /^(?:([^:/?#]+):)?(?:\/\/([^/?#]*))?([^?#]*)\??([^#]*)#?(.*)$/,
    _e = /[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}/i,
    ve = new RegExp("".concat(_e.source, "~[0-9]+"), "i"),
    be = new RegExp(
      "^/?(".concat(_e.source, ")(?:/(-/(?:[^/]+/)+)?([^/]*))?$"),
      "i"
    ),
    ye = function (e) {
      return be.exec(ge.exec(e)[3]);
    },
    we = function (e) {
      return e.replace(/[\\-\\[]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
    },
    xe = function (t) {
      ...
      return (
        (a = e.map(t.split("*"), we)), new RegExp("^" + a.join(".+") + "$", i)
      );
    },
    ke = function (e) {
      var t;
    ...
    Ce = function (t, a, i, n) {
      ...
      if (
        ...
        (d = u === i[0] && o === i[1]) ||
          (l += "-/crop/"
            ...
            .concat(n.left, ",")
            .concat(n.top, "/")),
        (r = a.downscale && (u > s[0] || o > s[1])),
        (c = a.upscale && (u < s[0] || o < s[1])),
        r || c)
      ) {
        var p = _(s, 2);
        (n.sw = p[0]),
      ...
      return (
        ((t = e.extend({}, t)).cdnUrlModifiers = l),
        (t.cdnUrl = "".concat(t.originalUrl).concat(l || "")),
        (t.crop = n),
        t
      );
    },
    Se = function (t, a, i) {
      ...
      return (
        (r = null),
        "" === (n = a.inputAcceptTypes) &&
          (n = a.imagesOnly ? "image/*" : null),
        (o = function () {
          return (
            (r = (a.multiple
              ? e('<input type="file" multiple>')
              : e('<input type="file">')
            )
              .attr("accept", n)
              .css({
        ...
        t
          ...
          .mousemove(function (t) {
            ...
            return (
              ...
              (i = o.top),
              (n = r.width()),
              r.css({ left: t.pageX - a - n + 10, top: t.pageY - i - 10 })
            );
          })
      );
    },
    Fe = function (t, a, i) {
      ...
      return (
        "" === (n = a.inputAcceptTypes) &&
          (n = a.imagesOnly ? "image/*" : null),
        e(a.multiple ? '<input type="file" multiple>' : '<input type="file">')
          .attr("accept", n)
          .attr(r)
    ...
    Te = "B KB MB GB TB PB EB ZB YB".split(" "),
    je = function (e) {
      var t,
        a,
        i,
      ...
      return (
        ...
        "".concat(o).concat(e, " ").concat(Te[i]).concat(l)
      );
    },
    De = { dataType: "json", crossDomain: !0, cache: !1 },
    Ie = function (t, a, i) {
      var n =
        arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
      return e.ajax(e.extend({ url: t, type: a, data: i }, n, De)).then(
        function (t) {
          var a;
          return t.error
            ? ((a = t.error.content || t.error), e.Deferred().reject(a))
            : t;
        },
        function (e, a, i) {
          var n;
          return (
            (n = "".concat(a, " (").concat(i, ")")),
            ae(
              "JSONP unexpected error: ".concat(n, " while loading ").concat(t)
            ),
            n
          );
        }
    ...
    Ee = function (t) {
      ...
      return e
        .Deferred(function (a) {
          return e.each(Oe, function (n, r) {
            var o;
            return (
              (o = e.isFunction(i[r[2]]) && i[r[2]]),
              t[r[1]](function () {
                var i;
                return (i = o && o.apply(this, arguments)) &&
                  e.isFunction(i.promise)
                  ? i
                      .promise()
                      .progress(a.notify)
                      .done(a.resolve)
  ...
  (E = {
    ...
    scriptBase: "//ucarecdn.com/widget/".concat("3.10.2", "/uploadcare/"),
    debugUploads: !1,
    integration: "",
  }),
    (Y = { multipleMax: { from: 0, to: 1e3 } }),
    (M = { multipleMax: { min: 1, max: 1e3 } }),
    (K = {
      tabs: {
        all:
    ...
    (W =
      ...
      (document.currentScript ||
        (J = document.getElementsByTagName("script"))[J.length - 1])),
    (R = w() && e(W).data("integration")) &&
      null != R &&
      (E = e.extend(E, { integration: R })),
    (H = function (t) {
      return e.isArray(t) || (t = (t = e.trim(t)) ? t.split(" ") : []), t;
    }),
    (I = function (e, t) {
      var a,
        i,
      ...
      for (a = 0, o = t.length; a < o; a++) {
        if (((r = t[a]), (c = s = H(e[r])), u.apply(K, [r])))
          for (c = [], n = 0, l = s.length; n < l; n++)
            (i = s[n]),
              u.apply(K[r], [i]) ? (c = c.concat(H(K[r][i]))) : c.push(i);
        e[r] = oe(c);
      }
      return e;
    }),
    ...
    (U = function (t, a) {
      ...
      for (i = 0, r = a.length; i < r; i++)
        null != t[(n = a[i])] &&
          ("string" == typeof (o = t[n])
            ? ((o = e.trim(o).toLowerCase()),
              (t[n] = !("false" === o || "disabled" === o)))
            : (t[n] = !!o));
      return t;
    }),
    (B = function (e, t) {
    ...
    (N = function (t) {
      ...
      return {
        ...
        upscale: !!a[4],
        notLess: "minimum" === a[4],
        preferedSize: a.length ? [+a[1], +a[3]] : void 0,
      };
    }),
    (q = function (t) {
      var a, i;
        ...
        ((i = a[1] * a[2]) > 5e6
          ? (ne(
              "Shrinked size can not be larger than 5MP. " +
                "You have set ".concat(a[1], "x").concat(a[2], " (") +
                "".concat(Math.ceil(i / 1e3 / 100) / 10, "MP).")
            ),
            !1)
          : { quality: a[3] ? a[3] / 100 : void 0, size: i })
      );
    }),
    (O = function (e, t) {
      var a, i, n, r;
    ...
    (V = function (t) {
      var a;
      return (
        I(t, ["tabs", "preferredTypes", "videoPreferredMimeTypes"]),
        X(t, ["cdnBase", "socialBase", "urlBase", "scriptBase"]),
        U(t, [
          "doNotStore",
          "imagesOnly",
          "multiple",
        ...
        !1 === t.crop ||
          e.isArray(t.crop) ||
          (/^(disabled?|false|null)$/i.test(t.crop)
            ? (t.crop = !1)
            : e.isPlainObject(t.crop)
            ? (t.crop = [t.crop])
            : (t.crop = e.map(("" + t.crop).split(","), N))),
        t.imageShrink &&
          !e.isPlainObject(t.imageShrink) &&
          (t.imageShrink = q(t.imageShrink)),
        (t.crop || t.multiple) && (t.previewStep = !0),
        z || (t.systemDialog = !1),
        t.validators && (t.validators = t.validators.slice()),
        t.previewProxy && !t.previewUrlCallback && (t.previewUrlCallback = O),
        -1 !== (a = t.tabs.indexOf("skydrive")) && (t.tabs[a] = "onedrive"),
        t
      );
    });
  var Be,
    Re = function () {
      var e, t, a;
      for (e in ((t = {}), E))
        null != (a = window["UPLOADCARE_".concat(fe(e))]) && (t[e] = a);
      return t;
    },
    Le = ce(function (t, a) {
      var i;
    ...
    Ve = function (t) {
      ...
      return (
        (a = e.extend({}, Le())),
        e.isEmptyObject(t) || (a = V(e.extend(a, t))),
        a
      );
    },
    Ne = w() && e.Callbacks("once memory"),
    qe = (function () {
      function e() {
        ...
        r(e, [
          {
            ...
            value: function (e) {
              ...
              if (!(Ue.call(this.urls, e) >= 0)) return this.urls.push(e);
            },
          },
          {
            key: "addStyle",
    ...
    We = function t(a) {
      return e.isArray(a)
        ? e.when.apply(null, e.map(a, t))
        : a.src
        ? Ke(a)
        : Ke(new window.Image(), a);
    },
    He = function (t) {
      var a = e.Deferred();
      return (
        e("<video/>")
          .on("loadeddata", a.resolve)
          .on("error", a.reject)
          .attr("src", t)
          .get(0)
          .load(),
    ...
    Ge = function () {
      var t = e.Deferred();
      if (void 0 !== Be) t.resolve(Be);
      else {
        var a = new window.Image();
        (a.onload = function () {
          (Be = a.naturalWidth < a.naturalHeight),
            (a.src = "//:0"),
            t.resolve(Be);
        }),
          (a.src =
      ...
      return (
        ...
        Q && Ye && D
          ? (Xe(function (n) {
              ...
              return (
                i.always(n),
                (r = We(Q.createObjectURL(t))).always(function (e) {
                  return Q.revokeObjectURL(e.src);
                }),
                r.fail(function () {
                ...
                r.done(function (n) {
                  i.notify(0.1);
                  var o = e.when(tt(t), Ge()).always(function (e, t) {
                    var l;
                    return (
                      i.notify(0.2),
                      (l = "resolved" === o.state()),
                      (r = Ze(n, a)).progress(function (e) {
                        ...
                        return (
                          ...
                          Pe(n, o, s, function (a) {
                            return (
                              ...
                              e
                                ? (t && at(e, 1),
                                  (r = et(a, 225, [e.buffer])).done(i.resolve),
                                  r.fail(function () {
                                    return i.resolve(a);
                                  }))
                                : i.resolve(a)
    ...
    Ze = function (t, a) {
      var i, n, r, o, l, s, c, u, d;
      return (
        (i = e.Deferred()),
        0.71,
        0.71 * t.width * t.height * 0.71 < a.size
          ? i.reject("not required")
          : ((u = r = t.width),
            (c = t.height),
            (o = u / c),
            (d = Math.floor(Math.sqrt(a.size * o))),
            (n = Math.floor(a.size / Math.sqrt(a.size * o))),
            5e6,
            4096,
            (l = function () {
              if (!(u <= d))
                return le(function () {
                  ...
                  return (
                    ...
                    0.71 * u < d && ((u = d), (c = n)),
                    u * c > 5e6 &&
                      ((u = Math.floor(Math.sqrt(5e6 * o))),
                      (c = Math.floor(5e6 / Math.sqrt(5e6 * o)))),
                    u > 4096 && ((u = 4096), (c = Math.round(u / o))),
                    c > 4096 && ((c = 4096), (u = Math.round(o * c))),
                    ((e = document.createElement("canvas")).width = u),
                    (e.height = c),
                    e.getContext("2d").drawImage(t, 0, 0, u, c),
                    (t.src = "//:0"),
                    (t.width = t.height = 1),
                    (t = e),
                    i.notify((r - u) / (r - d)),
            ...
            (s = function () {
              var e, a;
              return (
                ((e = document.createElement("canvas")).width = d),
                (e.height = n),
                ((a = e.getContext("2d")).imageSmoothingQuality = "high"),
                a.drawImage(t, 0, 0, d, n),
                (t.src = "//:0"),
                (t.width = t.height = 1),
                i.resolve(e)
              );
    ...
    Qe = function (t, a, i, n, r) {
      var o, l;
      return (
        (o = e.Deferred()),
        Q
          ? ((l = We(Q.createObjectURL(t))).always(function (e) {
              return Q.revokeObjectURL(e.src);
            }),
            l.fail(function () {
            ...
            l.done(function (l) {
              return (
                ...
                r && l.width * l.height > r
                  ? o.reject("max source")
                  : e.when(tt(t), Ge()).always(function (e, t) {
                      var r = t ? 1 : it(e) || 1,
                        s = r > 4,
                        c = s ? [l.height, l.width] : [l.width, l.height],
                        u = _(Ae(c, [a, i]), 2),
                        d = u[0],
                        p = u[1],
                        f = [
    ...
    $e = function (t) {
      ...
      return (
        (o = function (e, t) {
          var i;
          return (
            ((i = new $()).onload = function () {
              return t(new Ye(i.result));
            }),
            (i.onerror = function (e) {
              return a.reject("reader", e);
            }),
            i.readAsArrayBuffer(e)
          );
        }),
        (n = function () {
          return o(t.slice(i, i + 128), function (e) {
            var t, a, n;
            for (
          ...
          return (
            ...
            o(t.slice(i, (i += 4)), function (r) {
              ...
              return 4 !== r.byteLength || 255 !== r.getUint8(0)
                ...
                ? a.resolve()
                : ((l = r.getUint16(2) - 2),
                  o(t.slice(i, (i += l)), function (t) {
                    return t.byteLength !== l
                      ? a.reject("corrupted")
                      : (a.notify(e, l, s, t), n());
                  }));
            })
        ...
        $ && Ye
          ? ((i = 2),
            o(t.slice(0, 2), function (e) {
              return 65496 !== e.getUint16(0) ? a.reject("not jpeg") : n();
            }),
            a.promise())
          : a.reject("support")
      );
    ...
    et = function (t, a, i) {
      ...
      return (
        ...
        (r = []),
        (l = $e(t)).fail(n.reject),
        l.progress(function (e, t, i) {
          if (i === a) return o.push(e), r.push(t);
        }),
        l.done(function () {
          var e, l, s, c, u, d, p, f, h;
          for (p = [t.slice(0, 2)], c = 0, d = i.length; c < d; c++)
            (e = i[c]),
              (s = new Ye(new ArrayBuffer(4))).setUint16(0, 65280 + a),
              s.setUint16(2, e.byteLength + 2),
              p.push(s.buffer),
              p.push(e);
          for (
            f = 2, l = u = 0, h = o.length;
            h >= 0 ? u < h : u > h;
            l = h >= 0 ? ++u : --u
          )
            o[l] > f && p.push(t.slice(f, o[l])), (f = o[l] + r[l] + 4);
          return (
            p.push(t.slice(f, t.size)), n.resolve(new D(p, { type: t.type }))
          );
        }),
        n.promise()
      );
    ...
    tt = function (t) {
      ...
      return (
        (a = null),
        (i = $e(t)).progress(function (e, t, i, n) {
          if (
            !a &&
            225 === i &&
            n.byteLength >= 14 &&
            ...
            value: function () {
              ...
              return (
                ...
                this.settings.debugUploads &&
                  (te("Load file info.", this.fileId, this.settings.publicKey),
              ...
              return (
                ...
                (e.pipe = e.then = function () {
                  for (
                    ...
                    i[n] = arguments[n];
                  return t.__extendApi(Ee.apply(void 0, [e].concat(i)));
                }),
                e
              );
            },
    ...
    st = (function (t) {
      ...
      function n(e) {
        ...
        return (
          a(this, n),
          ((t = i.apply(this, arguments)).__file = e),
          (t.fileName = t.__file.name || "original"),
          t.__notifyApi(),
          t
        );
      }
      return (
        r(n, [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                this.__file.size >= this.settings.multipartMinSize && D
                  ? (this.setFile(), this.multipartUpload())
                  : ((a = F),
                    !this.settings.imageShrink || (a && a < 8)
                      ? (this.setFile(), this.directUpload())
                      : ((t = e.Deferred()),
                        (i = 0.4),
                        Je(this.__file, this.settings.imageShrink)
                          .progress(function (e) {
                            return t.notify(e * i);
                          })
          ...
          },
          {
            ...
            value: function (e) {
              return (
                lt || (lt = Me(this.settings.parallelDirectUploads)), lt(e)
              );
            },
          },
          {
                ...
                this.__file
                  ? this.fileSize > 104857600
                    ...
                    : (this.directRunner(function (i) {
                        var n;
                        if ((t.always(i), "pending" === a.apiDeferred.state()))
                          return (
                            (n = new window.FormData()).append(
                              "UPLOADCARE_PUB_KEY",
                              a.settings.publicKey
                            ),
                            n.append("signature", a.settings.secureSignature),
                            n.append("expire", a.settings.secureExpire),
                            n.append(
                              "UPLOADCARE_STORE",
                              a.settings.doNotStore ? "" : "auto"
                            ),
                            n.append("file", a.__file, a.fileName),
                            n.append("file_name", a.fileName),
                            n.append("source", a.sourceInfo.source),
                            a.__autoAbort(
                              e.ajax({
                                xhr: function () {
                                  var a;
                                ...
                                headers: {
                                  "X-UC-User-Agent": a.settings._userAgent,
                                },
                                contentType: !1,
                                processData: !1,
                                data: n,
            ...
            value: function () {
              ...
              return (
                ...
                this.__autoAbort(
                  ...
                  if (t.settings.debugUploads)
                    return ee("Can't start multipart upload.", a, e);
                })
              );
            },
          },
              ...
              for (
                l = [],
                  ...
                  c = function () {
                    ...
                    if (!(u >= f.fileSize))
                      return (
                        (s = u + f.settings.multipartPartSize),
                        f.fileSize < s + f.settings.multipartMinLastPartSize &&
                          (s = f.fileSize),
                        (o = f.__file.slice(u, s)),
                        (u = s),
                        (h = d),
                        (n += 1),
                        (d += 1),
                            ...
                            return (
                              ...
                              f.__autoAbort(
                                e.ajax({
                                  ...
                                  error: function () {
                                    return (r += 1) >
                                      f.settings.multipartMaxAttempts
                                      ? (f.settings.debugUploads &&
                                          ee(
                                            "Part #".concat(
                                              h,
  ...
  var ct = (function (t) {
    ...
    function n(t) {
      ...
      return (
        a(this, n),
        ((r = i.apply(this, arguments)).__input = t),
        (r.fileId = me()),
        (r.fileName = e(r.__input).val().split("\\").pop()),
        r.__notifyApi(),
        r
      );
    }
          ...
          value: function () {
            ...
            return (
              ...
              (this.__iframe = e("<iframe>")
                ...
                .on("error", t.reject)),
              (a = function (t, a) {
                return e("<input/>", { type: "hidden", name: t, value: a });
              }),
              ...
              (this.__iframeForm = e("<form>")
                ...
                .append(a("UPLOADCARE_PUB_KEY", this.settings.publicKey))
                .append(
                  a("UPLOADCARE_SIGNATURE", this.settings.secureSignature)
                )
                .append(a("UPLOADCARE_EXPIRE", this.settings.secureExpire))
                .append(a("UPLOADCARE_FILE_ID", this.fileId))
                .append(
                  a("UPLOADCARE_STORE", this.settings.doNotStore ? "" : "auto")
                )
                .append(a("UPLOADCARE_SOURCE", this.sourceInfo.source))
                .append(this.__input)
                .css("display", "none")
                .appendTo("body")
                .submit()),
              t.always(this.__cleanUp.bind(this))
            );
          },
        },
        {
  ...
  ct.prototype.sourceName = "local-compat";
  var ut = (function (e, t) {
                ...
                (this._machine = new e.Machine("initialized", t, {
                  ...
                  connectingPre: function () {
                    if (!1 === r.netInfo.isOnLine())
                      return (
                        r._machine.transition("waiting"), void m("unavailable")
                      );
                    var t = (function (t, a) {
                      var i = e.ws_port,
                        n = "ws://";
            ...
            var t = function (e) {
              ...
              a.call(this),
                e.bind("pusher_internal:authorized", function (a) {
                  ...
                  e.bind("pusher_internal:subscription_succeeded", function (
                    a
                  ) {
  ...
  var pt = (function (t) {
      ...
      var i = m(n);
      function n() {
        return a(this, n), i.apply(this, arguments);
      }
      return (
        r(n, [
          {
            ...
            value: function (e) {
              return (
                ...
                this.connect(),
                g(d(n.prototype), "subscribe", this).apply(this, arguments)
              );
            },
          },
          {
            ...
            value: function (t) {
              var a = this;
              g(d(n.prototype), "unsubscribe", this).apply(this, arguments),
                e.isEmptyObject(this.channels.channels) &&
                  (this.disconnectTimeout = setTimeout(function () {
                    return (a.disconnectTimeout = null), a.disconnect();
                  }, 5e3));
            },
          },
        ]),
    ...
    ft = function (e) {
      return null == dt[e] && (dt[e] = new pt(e)), dt[e].connect(), dt[e];
    },
    ht = (function (t) {
      u(n, t);
      var i = m(n);
      function n(e) {
        ...
        if (
          (a(this, n),
          ((t = i.apply(this, arguments)).__url = e),
          (r = ge.exec(t.__url)[3].split("/").pop()))
        )
          try {
            t.fileName = decodeURIComponent(r);
          } catch (e) {
            t.fileName = r;
          }
        return t.__notifyApi(), t;
      }
      return (
        r(n, [
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                (a = e.Deferred()),
                (n = new mt(this.settings)),
                (i = new gt(this.settings)),
                (t = {
                  pub_key: this.settings.publicKey,
                  signature: this.settings.secureSignature,
                  expire: this.settings.secureExpire,
                ...
                le(function () {
                  if ("pending" === r.apiDeferred.state())
                    return Ie(
                      "".concat(r.settings.urlBase, "/from_url/"),
                      "GET",
                      t,
                      { headers: { "X-UC-User-Agent": r.settings._userAgent } }
                    )
                      .fail(function (e) {
                        return (
                          r.settings.debugUploads &&
                            te("Can't start upload from URL.", e, t),
                          a.reject()
                        );
                      })
                      .done(function (t) {
                        ...
                        if ("pending" === r.apiDeferred.state())
                          return (
                            r.settings.debugUploads &&
                              (te("Start watchers.", t.token),
                              (o = setInterval(function () {
                                return te("Still watching.", t.token);
                              }, 5e3)),
                              a
                                .done(function () {
                                  return te("Stop watchers.", t.token);
                                })
                                .always(function () {
                                  return clearInterval(o);
                                })),
                            r.__listenWatcher(a, e([n, i])),
                            a.always(function () {
                              return (
                                e([n, i]).off(r.allEvents),
                                n.stopWatching(),
                                i.stopWatching()
                              );
                            }),
                            e(n).one(r.allEvents, function () {
                              if (i.interval)
                                return (
                                  r.settings.debugUploads &&
                                    te("Start using pusher.", t.token),
                                  i.stopWatching()
                                );
                            }),
                            n.watch(t.token),
          ...
          },
          {
            ...
            value: function (t, a) {
              var i = this;
              return a
                .on("progress", function (e, a) {
                  return (i.fileSize = a.total), t.notify(a.done / a.total);
                })
                .on("success", function (a, n) {
                  return (
                    e(a.target).trigger("progress", n),
                    (i.fileId = n.uuid),
  ...
  (ht.prototype.sourceName = "url"),
    (ht.prototype.allEvents = "progress success error fail");
  var mt = (function () {
      function t(e) {
        a(this, t), (this.settings = e);
        try {
          this.pusher = ft(this.settings.pusherKey);
        } catch (e) {
          this.pusher = null;
        }
      }
        ...
        r(t, [
          {
            ...
            value: function (t) {
              var a = this;
              if (((this.token = t), this.pusher))
                return this.pusher
                  .subscribe("task-status-".concat(this.token))
                  .bind_all(function (t, i) {
                    return e(a).trigger(t, i);
                  });
            },
          },
          {
    ...
    _t = (function (e) {
      ...
      function i(e) {
        ...
        return (
          ...
          (r = ye(e))
            ? ((n.fileId = r[1]), r[2] && (n.cdnUrlModifiers = r[2]))
            : n.__rejectApi("baddata"),
          n
        );
      }
      return i;
    })(ot);
  _t.prototype.sourceName = "uploaded";
  var vt = (function (e) {
    u(i, e);
    var t = m(i);
    function i(e) {
      ...
      return (
        ...
        (n = t.apply(this, arguments)),
        e
          ? ((n.fileId = e.uuid), n.__handleFileData(e))
          : n.__rejectApi("deleted"),
        n
      );
    }
    return i;
  })(ot);
  vt.prototype.sourceName = "uploaded";
  var bt = { object: st, input: ct, url: ht, uploaded: _t, ready: vt },
    yt = function (e, t, a) {
      return wt(e, [t], a)[0];
    },
    wt = function (t, a, i) {
      var n, r, o, l, s;
      for (i = Ve(i || {}), s = [], n = 0, o = a.length; n < o; n++)
        (l = a[n]),
          (r = void 0),
          e.isArray(l) && ((r = l[1]), (l = l[0])),
          s.push(new bt[t](l, i, r).promise());
      return s;
    },
    xt = function (e) {
    ...
    kt = function (e, t) {
      return e && !xt(e) && (e = yt("uploaded", e, t)), e || null;
    },
    zt = function (e) {
      ...
      return (
        r(t, [
          ...
          },
          {
            ...
            value: function (t) {
              var a;
              if (-1 !== (a = e.inArray(t, this.__items)))
                return this.__remove(t, a);
            },
          },
          {
            key: "__remove",
          ...
          },
          {
            ...
            value: function (t, a) {
              var i;
              if (t !== a && -1 !== (i = e.inArray(t, this.__items)))
                return this.__replace(t, a, i);
            },
          },
          {
            key: "__replace",
        ...
        r(i, [
          {
            key: "add",
            value: function (e) {
              if (!(St.call(this.__items, e) >= 0))
                return g(d(i.prototype), "add", this).apply(this, arguments);
            },
          },
          {
            key: "__replace",
            value: function (e, t, a) {
              return St.call(this.__items, t) >= 0
                ? this.remove(e)
                : g(d(i.prototype), "__replace", this).apply(this, arguments);
            },
          },
        ]),
        i
    ...
    jt = (function (t) {
      ...
      function n() {
        ...
        return (
          ...
          )).anyDoneList = e.Callbacks()),
          (r.anyFailList = e.Callbacks()),
          (r.anyProgressList = e.Callbacks()),
          (r._thenArgs = null),
          r.anyProgressList.add(function (t, a) {
            return e(t).data("lastProgress", a);
          }),
          g(((t = f(r)), d(n.prototype)), "init", t).call(t, arguments[0]),
          r
        );
      }
      return (
        r(n, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (
                ...
                (a = r[i]), o.push(t(a, e(a).data("lastProgress")));
              return o;
            },
          },
          {
            ...
            value: function () {
              var t, a, i, n, r;
              for (r = [], a = 0, i = (n = this.__items).length; a < i; a++)
                (t = n[a]), r.push(e(t).data("lastProgress"));
              return r;
            },
          },
          {
            ...
            value: function (e) {
              if (e && e.then) {
                var t;
                if (this._thenArgs)
                  e = (t = e).then.apply(t, v(this._thenArgs));
                return (
                  g(d(n.prototype), "add", this).call(this, e),
                  this.__watchItem(e)
                );
              }
            },
          },
          {
            ...
            value: function (e, t, a) {
              return t && t.then
                ? (g(d(n.prototype), "__replace", this).apply(this, arguments),
                  this.__watchItem(t))
                : this.remove(e);
            },
          },
              ...
              for (
                ...
                (t = n[e]),
                  r.push(
                    this.__replace(
                      t,
                      (c = t).then.apply(c, v(this._thenArgs)),
                      e
                    )
                  );
              }
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "تمت مطالبتك بالسماح بالدخول إلى الكاميرا من هذا الموقع<br>من أجل التقاط الصور من الكاميرا يجب عليك الموافقة على هذا الطلب",
                },
                notFound: {
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Bu saytdan kameranıza daxil olmaq icazəsi verildi. Kameranız ilə şəkil çəkmək üçün bu sorğunu təsdiq etməlisiniz.",
                },
                notFound: {
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Aquest lloc t'ha demanat de permetre accés a la càmera. Per tal de realitzar imatges amb la teva càmera has d'acceptar aquesta petició.",
                },
                notFound: {
                  title: "No s'ha detectat cap càmera",
                  text:
                    "Sembla que no tens cap càmera connectada a aquest dispositiu.",
                },
              },
              preview: {
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Byl(a) jste požádán(a) o přístup k webkameře. Abyste mohl(a) pořídit fotografii, musíte přístup povolit.",
                },
                notFound: {
                  title: "Nebyla nalezena webkamera",
                  text:
                    "Zdá se, že k tomuto zařízení není připojena žádná webkamera.",
                },
              },
              preview: {
                unknownName: "neznámý",
            ...
            tabs: {
              ...
              preview: {
                ...
                image: {
                  ...
                  text:
                    "Bitte veruschen Sie es erneut mit einer anderen Datei.",
                  back: "Bild wählen",
                },
                error: {
                  default: {
                  ...
                  size: {
                    ...
                    text:
                      "Bitte versuchen Sie es erneut mit einer anderen Datei.",
                  },
                  loadImage: {
                    title: "Fehler",
            ...
            tabs: {
              ...
              camera: {
                ...
                notFound: {
                  ...
                  text:
                    "Φαίνεται ότι δεν έχετε κάμερα συνδεδεμένη με αυτή τη συσκευή.",
                },
              },
              preview: {
                unknownName: "άγνωστο",
        ...
        translations: {
          ...
          buttons: {
            ...
            choose: {
              ...
              images: { one: "Tải ảnh mặt hàng", other: "Choose images" },
            },
          },
          dialog: {
            close: "Close",
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "You have been prompted to allow camera access from this site.<br>In order to take pictures with your camera you must approve this request.",
                },
                notFound: {
                  title: "No camera detected",
                  text:
                    "Looks like you have no camera connected to this device.",
                },
              },
              preview: {
                unknownName: "unknown",
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Este sitio ha pedido permiso para acceder a la cámara. Para tomar imágenes con tu cámara debes aceptar esta petición.",
                },
                notFound: {
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  title: "Please allow access to your camera",
                  text:
                    "You have been prompted to allow camera access from this site. In order to take pictures with your camera you must approve this request.",
                },
                notFound: {
                  title: "No camera detected",
                  text:
              ...
              preview: {
                ...
                error: {
                  ...
                  image: {
                    ...
                    text:
                      "Merci de bien vouloir recommencer avec un autre fichier.",
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  title: "카메라 접근 허용",
                  text:
                    "카메라 접근을 허용하시겠습니까?<br>승인 요청을 해주셔야 합니다",
                },
                notFound: {
                  title: "카메라가 없습니다",
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Zostałeś poproszony przez tę stronę o dostęp do aparatu. Aby robić zdjecia, musisz zaakceptować tę prośbę.",
                },
                notFound: {
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Você foi solicitado a permitir o acesso à câmera a partir deste site. Para tirar fotos com sua câmera, você deve aprovar este pedido.",
                },
                notFoud: {
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Ai fost rugat să dai acces la cameră de acest site.<br>Pentru a putea face fotografii cu camera, trebuie să aprobi această cerere.",
                },
                notFound: {
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Для того, чтобы сделать снимок, мы запросили разрешение на доступ к камере с этого сайта.",
                },
                notFound: {
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Boli ste vyzvaní aby ste umožnili tejto stránke prístup ku kamere.<br>Prístup musíte povolit aby ste mohli fotiť s vašou kamerou.",
                },
                notFound: {
                  title: "Kamera nebola nájdená",
                  text:
                    "Zdá sa, že k tomuto zariadeniu nemáte pripojenú kameru.",
                },
              },
              preview: {
                unknownName: "neznámy",
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Упитани сте да дозволите приступ вашој камери са овог сајта.<br>Уколико желите да сликате, морате одобрити овај захтев.",
                },
                notFound: {
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Du har uppmanats att tillåta att denna webbplats får tillgång till din kamera.För att ta bilder med din kamera måste du godkänna denna begäran.",
                },
                notFound: {
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  ...
                  text:
                    "Вам буде запропоновано дозволити доступ до камери з цього сайту.<br>Для того, щоб фотографувати за допомогою камери, ви повинні схвалити цей запит.",
                },
                notFound: {
                  title: "Камера не виявлена",
                  text:
                    "Схоже, у вас немає камери, підключеної до цього пристрою.",
                },
              },
              preview: {
            ...
            tabs: {
              ...
              camera: {
                ...
                notFound: {
                  ...
                  text:
                    "Có vẻ như bạn không có camera nào nối với thiết bị này.",
                },
              },
              preview: {
                unknownName: "vô danh",
            ...
            tabs: {
              ...
              camera: {
                ...
                pleaseAllow: {
                  title: "請允許使存取您的相機",
                  text:
                    "你一直在提示允許來自這個網站的訪問攝像頭。為了拍照用你的相機，你必須批准這一請求。",
                },
                notFound: {
                  title: "沒有找到相機",
                  text: "看起來你有沒有將連接相機。",
    ...
    It = null,
    Pt = {
      translations: Object.keys(Dt).reduce(function (e, t) {
        return (e[t] = Dt[t].translations), e;
      }, {}),
      pluralize: Object.keys(Dt).reduce(function (e, t) {
        return (e[t] = Dt[t].pluralize), e;
      }, {}),
      rebuild: function (e) {
        return (It = null), Ot(e);
      },
      t: function (e, t) {
        ...
        return (
          (a = Ot()),
          null == (n = Et(e, a.translations)) &&
            a.lang !== Mt.lang &&
            (n = Et(e, (a = Mt).translations)),
          null != t &&
            (n =
              null != a.pluralize
    ...
    Mt = {
      lang: "en",
      translations: Dt.en.translations,
      pluralize: Dt.en.pluralize,
    },
    Ot = function (t) {
      if (!It) {
        var a = Ve(t),
          i = a.locale || Mt.lang,
          n = e.extend(!0, {}, Pt.translations[i], a.localeTranslations),
          r = e.isFunction(a.localePluralize)
            ? a.localePluralize
            : Pt.pluralize[i];
        It = { lang: i, translations: n, pluralize: r };
      }
      return It;
    },
    Et = function (e, t) {
    ...
    Ut = (function () {
      function t(i, n) {
        ...
        a(this, t),
          (this.__uuid = null),
          (this.settings = Ve(n)),
          (this.__fileColl = new jt(i)),
          (this.__allFilesDf = e.when.apply(e, v(this.files()))),
          (this.__fileInfosDf =
            ((i = function () {
              var t, a, i, n;
              for (n = [], t = 0, a = (i = this.files()).length; t < a; t++)
                (r = i[t]),
                  n.push(
                    r.then(null, function (t, a) {
                      return e.when(a);
                    })
                  );
              return n;
      ...
      return (
        r(t, [
                ...
                (t = {
                  ...
                  cdnUrl: this.__uuid
                    ? ""
                        ...
                        .concat(this.__uuid, "/")
                    : null,
                  name: Pt.t("file", this.__fileColl.length()),
              ...
              return (
                ...
                this.__fileColl.length()
                  ? this.__fileInfosDf.done(function () {
                      ...
                      var r;
                      return Ie(
                        "".concat(a.settings.urlBase, "/group/"),
                        "POST",
                        {
                          pub_key: a.settings.publicKey,
                          signature: a.settings.secureSignature,
                          expire: a.settings.secureExpire,
                          files: (function () {
                            var e, t, a;
                        ...
                        {
                          headers: { "X-UC-User-Agent": a.settings._userAgent },
                        }
                      )
                        .fail(function (e) {
                          return (
                            a.settings.debugUploads &&
                              ee(
                                "Can't create group.",
                                a.settings.publicKey,
                                e
          ...
          },
          {
            ...
            value: function () {
              return (
                this.__api || (this.__api = pe(this, ["promise", "files"])),
                this.__api
              );
            },
          },
    ...
    Bt = (function (e) {
      ...
      function i(e, n) {
        ...
        return (
          a(this, i),
          (o = wt("ready", e.files, n)),
          ((r = t.call(this, o, n)).__data = e),
          r
        );
      }
      return (
    ...
    Rt = function () {
      ...
      for (t = [], i = 0, r = s.length; i < r; i++)
        if (((a = s[i]), xt(a))) t.push(a);
        else if (zt(a))
          for (n = 0, o = (l = a.files()).length; n < o; n++)
            (e = l[n]), t.push(e);
      return new Ut(t, c).api();
    },
    Lt = function (t, a) {
      var i, n;
      return (
        ...
        (n = ve.exec(t))
          ? Ie(
              "".concat(a.urlBase, "/group/info/"),
              "GET",
              { jsonerrors: 1, pub_key: a.publicKey, group_id: n[0] },
              { headers: { "X-UC-User-Agent": a._userAgent } }
            )
              .fail(function (e) {
                return (
                  a.debugUploads &&
              ...
              .done(function (e) {
                var t;
                return (t = new Bt(e, a)), i.resolve(t.api());
              })
          : i.reject(),
        i.promise()
      );
  ...
  w() &&
    e(window).on("message", function (e) {
      ...
      if ((null != n ? n.type : void 0) && n.type in Vt) {
        for (o = [], t = 0, i = (r = Vt[n.type]).length; t < i; t++)
          (a = r[t]), l.source === a[0] ? o.push(a[1](n)) : o.push(void 0);
        return o;
      }
    });
  var Nt = function (e, t, a) {
      return e in Vt || (Vt[e] = []), Vt[e].push([t, a]);
    },
    qt = function (t, a) {
      if (t in Vt)
        return (
          (Vt[t] = e.grep(Vt[t], function (e) {
            return e[0] !== a;
          })),
          Vt[t]
        );
        ...
        a(this, t),
          ...
          this.dialogApi.progress(function (e) {
            return (
              e === l.name &&
                (l.__createIframe(),
                l.container.find(".uploadcare--tab__iframe").focus()),
              l.__sendMessage({
                  ...
                  (this.iframe = e("<iframe>", {
                    ...
                    .on("load", function () {
                      ...
                      for (
                        ...
                        (s = r[e]),
                          a.__sendMessage({ type: "embed-css", url: s });
                      for (t = 0, n = (o = Kt.styles).length; t < n; t++)
                        (l = o[t]),
                          a.__sendMessage({ type: "embed-css", style: l });
                    })),
                  this.container.addClass("uploadcare--tab_remote"),
                  (t = this.iframe[0].contentWindow),
                  Nt("file-selected", t, function (t) {
                    var i, n, r;
                    return (
                      (r = (function () {
                        var e, i, n, r, o;
                        if (t.alternatives)
                          for (
                            e = 0, n = (r = a.settings.preferredTypes).length;
                            e < n;
                            e++
                          )
                            for (i in ((o = r[e]), (o = xe(o)), t.alternatives))
                              if (o.test(i)) return t.alternatives[i];
                        return t.url;
                      })()),
                      (n = e.extend({ source: a.name }, t.info || {})),
                      (i = new ht(r, a.settings, n)),
                      t.filename && i.setName(t.filename),
                      null != t.is_image && i.setIsImage(t.is_image),
                      a.dialogApi.addFiles([i.promise()])
                    );
                  }),
                  Nt("open-new-window", t, function (e) {
                    var t, i, n;
                    if (
                      (a.settings.debugUploads &&
                        te("Open new window message.", a.name),
                      ...
                      return (
                        (n = function () {
                          return (
                            a.settings.debugUploads &&
                              te("Window is closed.", a.name),
                            a.__sendMessage({ type: "navigate", fragment: "" })
                          );
                        }),
                        "closed" in i
                          ? (t = setInterval(function () {
                              if (i.closed) return clearInterval(t), n();
                            }, 100))
                          : i.addEventListener("exit", n)
                      );
                    ae("Can't open new window. Possible blocked.", a.name);
                  }),
                  this.dialogApi.done(function () {
                    return qt("file-selected", t), qt("open-new-window", t);
                  })
                );
            },
          },
    ...
    Ht = {
      ...
      utils: {
        ...
        image: {
          ...
          replaceJpegChunk: et,
          getExif: tt,
          parseExifOrientation: it,
          hasTransparency: rt,
        },
        pusher: { getPusher: ft },
        isFileGroup: zt,
        valueToGroup: At,
        isFileGroupsEqual: Ct,
      },
      settings: {
        globals: Re,
        build: Ve,
  ...
  var Yt = {
      ...
      version: "3.10.2",
      jQuery: e,
      defaults: c(c({}, E), {}, { allTabs: K.tabs.all }),
      globals: Le,
      start: Le,
      fileFrom: yt,
      filesFrom: wt,
  ...
  var Zt = {
      dialog: function () {
        return '<div class="uploadcare--dialog"><div class="uploadcare--dialog__container"><button type="button" title="'
          .concat(Pt.t("dialog.close"), '" aria-label="')
          .concat(
            Pt.t("dialog.close"),
          ...
          .concat(Pt.t("dialog.footer.link"), "</a></div></div>");
      },
      dialog__panel: function () {
        return '<div class="uploadcare--panel"><div class="uploadcare--menu uploadcare--panel__menu"><button type="button" title="'
          .concat(Pt.t("dialog.openMenu"), '" aria-label="')
          .concat(
            Pt.t("dialog.openMenu"),
          ...
          .concat(Pt.t("dialog.footer.link"), "</a></div></div></div>");
      },
      ...
      "tab-camera-capture": function () {
        return '<div class="uploadcare--tab__content"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title">'
          ...
          .concat(
            Pt.t("dialog.tabs.camera.capture"),
          ...
          .concat(
            Pt.t("dialog.tabs.camera.startRecord"),
            "</button></div></div>"
          );
      },
      "tab-camera": function () {
        return '<div class="uploadcare--tab__content"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title">'
          ...
          .concat(
            Pt.t("dialog.tabs.camera.mirror"),
          ...
          .concat(
            Pt.t("dialog.tabs.camera.cancelRecord"),
      ...
      "tab-file": function () {
        return '<div class="uploadcare--tab__content uploadcare--draganddrop"><div class="uploadcare--text uploadcare--text_size_extra-large uploadcare--dragging__show">'
          ...
          .concat(
            Pt.t("dialog.tabs.file.drag"),
            '</div><div class="uploadcare--text uploadcare--text_size_small uploadcare--text_muted">'
          )
          .concat(
            Pt.t("dialog.tabs.file.or"),
            '</div></div><div class="uploadcare--text uploadcare--text_size_large uploadcare--draganddrop__not-supported">'
          )
          .concat(
            Pt.t("dialog.tabs.file.nodrop"),
            '</div></div><button type="button" class="btn btn-success uploadcare--tab__action-button needsclick uploadcare--dragging__hide">'
          )
          .concat(
            Pt.t("dialog.tabs.file.button"),
      ...
      "tab-preview-error": function (e) {
        ...
        return '<div class="uploadcare--tab__content uploadcare--preview__content uploadcare--error"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title uploadcare--preview__title">'
          .concat(
            Pt.t("dialog.tabs.preview.error." + t + ".title") ||
              Pt.t("dialog.tabs.preview.error.default.title"),
            '</div><div class="uploadcare--text">'
          )
          .concat(
            Pt.t("dialog.tabs.preview.error." + t + ".text") ||
              Pt.t("dialog.tabs.preview.error.default.text"),
            '</div><button type="button" class="uploadcare--button uploadcare--preview__back">'
          )
          .concat(
            Pt.t("dialog.tabs.preview.error." + t + ".back") ||
              Pt.t("dialog.tabs.preview.error.default.back"),
            "</button></div>"
          );
      },
      "tab-preview-image": function (e) {
        ...
        return '<div class="uploadcare--tab__header"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title uploadcare--preview__title">'
          .concat(
            Pt.t("dialog.tabs.preview.image.title"),
          ...
          .concat(
            Pt.t("dialog.tabs.preview.image.change"),
          ...
          .concat(Pt.t("dialog.tabs.preview.done"), "</button></div>");
      },
      "tab-preview-multiple-file": function () {
        return '<div class="uploadcare--file uploadcare--files__item uploadcare--file_status_uploading"><div class="uploadcare--file__description" tabindex="0"><div class="uploadcare--file__preview"></div><div class="uploadcare--file__name">'.concat(
          Pt.t("dialog.tabs.preview.unknownName"),
      ...
      "tab-preview-multiple": function () {
        return '<div class="uploadcare--tab__header"><div id="preview__title" class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title uploadcare--preview__title" role="status" aria-live="assertive"></div></div><div class="uploadcare--tab__content uploadcare--preview__content"><div class="uploadcare--files"></div></div><div class="uploadcare--footer uploadcare--tab__footer"><div class="uploadcare--footer__additions uploadcare--preview__message"></div><button type="button" class="uploadcare--button uploadcare--footer__button uploadcare--preview__back">'
          .concat(
            Pt.t("dialog.tabs.preview.multiple.clear"),
          ...
          .concat(Pt.t("dialog.tabs.preview.multiple.done"), "</button></div>");
      },
      "tab-preview-regular": function (e) {
        ...
        return '<div class="uploadcare--tab__header"><div id="tab__title" class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title" role="status" aria-live="assertive">'
          .concat(
            Pt.t("dialog.tabs.preview.regular.title"),
          ...
          .concat(Jt(t.name) || Pt.t("dialog.tabs.preview.unknownName"), " ")
          .concat(
            je(t.size, "", ", "),
          ...
          .concat(
            Pt.t("dialog.tabs.preview.change"),
      ...
      "tab-preview-unknown": function () {
        return '<div class="uploadcare--tab__header"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title uploadcare--preview__title">'
          .concat(
            Pt.t("dialog.tabs.preview.unknown.title"),
          ...
          .concat(Pt.t("dialog.tabs.preview.unknown.done"), "</button></div>");
      },
      "tab-preview-video": function () {
        return '<div class="uploadcare--tab__header"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title uploadcare--preview__title">'
          .concat(
            Pt.t("dialog.tabs.preview.video.title"),
          ...
          .concat(
            Pt.t("dialog.tabs.preview.video.change"),
            '</button> <button type="button" class="uploadcare--button uploadcare--button_primary uploadcare--footer__button uploadcare--preview__done">'
          )
          .concat(Pt.t("dialog.tabs.preview.done"), "</button></div>");
      },
      "tab-url": function () {
        return '<div class="uploadcare--tab__content"><div class="uploadcare--text uploadcare--text_size_large uploadcare--tab__title">'
          .concat(
            Pt.t("dialog.tabs.url.title"),
            '</div><div class="uploadcare--text">'
          )
          .concat(
            Pt.t("dialog.tabs.url.line1"),
            '</div><div class="uploadcare--text">'
          )
          .concat(
            Pt.t("dialog.tabs.url.line2"),
            '</div><form class="uploadcare--form"><input type="text" class="uploadcare--input" placeholder="'
          )
          .concat(
            Pt.t("dialog.tabs.url.input"),
            '"> <button type="submit" class="uploadcare--button uploadcare--button_primary uploadcare--tab__action-button" type="submit">'
          )
          .concat(Pt.t("dialog.tabs.url.button"), "</button></form></div>");
      },
      "widget-button": function (e) {
        var t = e.caption,
          a = e.name;
        return '<button type="button" class="btn btn-success uploadcare--widget__button_type_'
          .concat(a, '">')
          .concat(t, "</button>");
      },
  ...
  var $t = function (e) {
    ...
    ta = '[role~="uploadcare-upload-form"]',
    aa = ta + "[data-uploadcare-submitted]";
  if (w()) {
    e(document).on("submit", ta, function () {
      var t;
      return (t = e(this)), !!$t(t) || (ea(t, !0), !1);
    }),
      e(document).on("loaded.uploadcare", aa, function () {
        return e(this).submit();
      });
    e(document).on("ready.uploadcare error.uploadcare", aa, function () {
      var t;
      if (((t = e(this)), $t(t))) return ea(t, !1);
    });
  }
  var ia = [
  ...
  w() &&
    e(document.documentElement)
      .on("mousedown", ia, function (t) {
        return le(function () {
          var t;
          if ((t = document.activeElement) && t !== document.body)
            return e(t)
              .addClass("uploadcare--mouse-focused")
              .one("blur", function () {
                return e(t).removeClass("uploadcare--mouse-focused");
              });
        });
      })
      .on("keypress", ia, function (t) {
        if (13 === t.which || 32 === t.which)
          return e(this).click(), t.preventDefault(), t.stopPropagation();
      });
  var na = (function () {
      function e(t) {
        a(this, e),
          (this.renderer = C ? new la(t) : new oa(t)),
          (this.observed = null);
      }
      return (
        r(e, [
            ...
            value: function (e, t) {
              ...
              return (
                ...
                "resolved" === this.observed.state()
                  ...
                  : this.observed
                      .progress(function (t) {
                        if (e === i.observed) return i.renderer.setValue(a(t));
                      })
                      .always(function (t) {
                        if (e === i.observed) return i.renderer.setValue(1, !1);
                      }),
                this
              );
            },
    ...
    ra = (function () {
      ...
      return r(t, [{ key: "update", value: function () {} }]), t;
    })(),
    oa = (function (e) {
      u(i, e);
      var t = m(i);
      function i() {
        ...
        return (
          ...
          e.element.html(Qt("progress__text")),
    ...
    la = (function (t) {
      ...
      function n() {
        ...
        return (
          a(this, n),
          ((t = i.apply(this, arguments)).canvasEl = e("<canvas>")
            .addClass("uploadcare--progress__canvas")
            .get(0)),
          t.element.addClass("uploadcare--progress_type_canvas"),
          t.element.html(t.canvasEl),
          t.setValue(0, !0),
          t
        );
      }
        ...
        r(n, [
          {
            ...
            value: function () {
              ...
              if (
                ...
                return (
                  (this.canvasEl.width === i && this.canvasEl.height === i) ||
                    ((this.canvasEl.width = i), (this.canvasEl.height = i)),
                  (e = function (e, i) {
                    var n;
                    return (
                      ...
                      t.beginPath(),
                      t.moveTo(a, a),
                      t.arc(a, a, e, n, n + 2 * Math.PI * i, !1),
                      t.fill()
                    );
                  }),
                  (t = this.canvasEl.getContext("2d")).clearRect(0, 0, i, i),
    ...
    ca = function (e, t, a) {
      return (
        (a = Ve(a)),
        ua(e, function (e, i) {
          return t(a.multiple ? wt(e, i, a) : yt(e, i[0], a));
        })
      );
    },
    ua = sa
      ? function (t, a) {
          da(t),
            e(t).on({
              ...
              drop: function (t) {
                var i, n, r, o, l, s;
                if ((t.preventDefault(), (i = t.originalEvent.dataTransfer))) {
                  if (i.files.length) return a("object", i.files);
                  for (
                    s = [],
                      n = 0,
                    ...
                    (l = o[n]), (l = e.trim(l)) && "#" !== l[0] && s.push(l);
                  return s ? a("url", s) : void 0;
                }
              },
            });
        }
    ...
    da = sa
      ? function (t, a) {
          ...
          return (
            ...
            (i = function (a) {
              if (r !== a)
                return (r = a), e(t).toggleClass("uploadcare--dragging", a);
            }),
            e(a || t).on({
              dragenter: function () {
                return (n += 1), i(!0);
      ...
      return (
        r(t, [
            ...
            value: function (t) {
              var a =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : "";
              return e(Qt("widget-button", { name: t, caption: a })).appendTo(
                this.content
              );
            },
          },
              ...
              return (
                ...
                e.progress(function (a) {
                  if (e === t.__file)
                    switch (a.state) {
                      case "uploading":
                        return t.statusText.text(Pt.t("uploading"));
                      case "uploaded":
                        return t.statusText.text(Pt.t("loadingInfo"));
                    }
                })
              );
            },
          },
          {
            ...
            value: function (e) {
              return (
                this.statusText.text(Pt.t("errors.".concat(e || "default"))),
                this.content.attr("aria-busy", !1),
    ...
    ma = (function () {
      function t(e, i, n, r, o) {
        a(this, t),
          ...
          (this.settings = r),
          (this.name = o),
          this.container.append(Qt("tab-file")),
        ...
        r(t, [
          {
            ...
            value: function () {
              var e,
                t = this;
              if (((e = this.container.find(".uploadcare--draganddrop")), S))
                return (
                  ua(e, function (e, a) {
                    return (
                      t.settings.multiple
            ...
            value: function () {
              ...
              return (
                ...
                z
                  ? e.on("click", function () {
                      return (
                        Fe(t.container, t.settings, function (e) {
                          return (
            ...
            value: function (t) {
              ...
              return (
                ...
                e("<button>")
                  ...
                  .addClass("uploadcare--file-source_".concat(t))
                  .addClass("uploadcare--file-sources__item")
                  .attr("type", "button")
                  .attr("title", Pt.t("dialog.tabs.names.".concat(t)))
                  .attr("data-tab", t)
                  .append(a)
                  .on("click", function () {
                    return i.dialogApi.switchTab(t);
                  })
              );
            },
          },
    ...
    ga = (function () {
      function t(i, n, r, o, l) {
        ...
        a(this, t),
          ...
          (this.settings = o),
          (this.name = l),
          this.container.append(Qt("tab-url")),
          (c = this.container.find(".uploadcare--input")).on(
            "change keyup input",
            function () {
              var t = !e.trim(this.value);
              return s.attr("disabled", t).attr("aria-disabled", t);
            }
          ),
          (s = this.container
          ...
          this.container.find(".uploadcare--form").on("submit", function () {
            ...
            return (
              e &&
                (u.dialogApi.addFiles("url", [[e, { source: "url-tab" }]]),
  ...
  (fa = /^[a-z][a-z0-9+\-.]*:?\/\//),
    (pa = function (t) {
      return (t = e.trim(t)), fa.test(t) ? t : "http://" + t;
    });
  var _a = w() && "https:" === document.location.protocol,
    va = (function () {
      function t(e, i, n, r, o) {
        var l;
        if (
          ...
          this.container.append(Qt("tab-camera-capture")),
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                this.container.append(Qt("tab-camera")),
                this.container.addClass("uploadcare--camera"),
                ...
                (this.MediaRecorder && !this.settings.imagesOnly) || e.hide(),
                ...
                this.dialogApi.progress(function (e) {
                  ...
                  } else if (t.__loaded && _a) return t.__revoke();
                }),
            ...
            value: function () {
              ...
              return (
                navigator.mediaDevices && navigator.mediaDevices.getUserMedia
                  ? (this.getUserMedia = function (e, t, a) {
                ...
                (e = "localhost" === document.location.hostname),
                !!this.getUserMedia && Uint8Array && (_a || e)
              );
            },
          },
          {
              ...
              if (
                ...
                return (
                  ...
                  this.__stream.getTracks
                    ? e.each(this.__stream.getTracks(), function () {
                        return "function" == typeof this.stop
                          ? this.stop()
                          : void 0;
                      })
                    : "function" == typeof (t = this.__stream).stop && t.stop(),
                  (this.__stream = null),
                  this.__stream
                );
            },
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                Pe(e, "image/jpeg", 0.9, function (t) {
                  return (
                    (e.width = e.height = 1),
                    (t.name = "camera.jpg"),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (null != i) {
                ...
                })(e.isArray(i) ? i : [i], function (e) {
                  return t.MediaRecorder.isTypeSupported(e);
                });
                null != n && (a.mimeType = n);
              }
              ...
              return (
                ...
                null !== this.settings.audioBitsPerSecond &&
                  (a.audioBitsPerSecond = this.settings.audioBitsPerSecond),
                null !== this.settings.videoBitsPerSecond &&
                  (a.videoBitsPerSecond = this.settings.videoBitsPerSecond),
                0 !== Object.keys(a).length
                  ? (this.__recorder = new this.MediaRecorder(this.__stream, a))
                  : (this.__recorder = new this.MediaRecorder(this.__stream)),
                this.__recorder.start(),
                (this.__recorder.ondataavailable = function (e) {
                  return t.__chunks.push(e.data);
                }),
  ...
  w() &&
    (function (e) {
      (e.Jcrop = function (a, i) {
        var n,
          r = e.extend({}, e.Jcrop.defaults);
        function o(e) {
        ...
        if ("IMG" == a.tagName) {
          ...
          (C = k.css(x).show()), (z = !1), null === r.shade && (r.shade = !0);
        (_ = C),
          (v = r.boxWidth),
          (b = r.boxHeight),
          (y = _.width()),
        ...
        var S = C.width(),
          ...
          T = e("<div />")
            ...
            .height(F)
            .addClass(l("holder"))
            .css({ position: "relative", backgroundColor: r.bgColor })
            .insertAfter(k)
            .append(C);
        ...
        var K = (function () {
            ...
            return {
              ...
              isSupported: e,
              support:
                !0 === r.touchSupport || !1 === r.touchSupport
                  ? r.touchSupport
                  : e(),
            };
          })(),
                  ...
                  : ((e = n),
                    ...
                    (t = g < 0 ? i - s : i + s) < 0
                      ...
                      : t > F &&
                        ...
                        (e = m < 0 ? a - l : l + a))),
                e > a
                  ? (e - a < p ? (e = a + p) : e - a > f && (e = a + f),
                    (t = t > i ? i + (e - a) / d : i - (e - a) / d))
                  : e < a &&
                    (a - e < p ? (e = a - p) : a - e > f && (e = a - f),
                    (t = t > i ? i + (a - e) / d : i - (a - e) / d)),
                e < 0 ? ((a -= e), (e = 0)) : e > S && ((a -= e - S), (e = S)),
                t < 0 ? ((i -= t), (t = 0)) : t > F && ((i -= t - F), (t = F)),
                u(c(a, i, e, t))
              );
            }
            function s(e) {
          ...
          H = (function () {
            ...
            function l(e) {
              i.top.css({ left: o(e.x), width: o(e.w), height: o(e.y) }),
                i.bottom.css({
                  top: o(e.y2),
                  left: o(e.x),
                  width: o(e.w),
                ...
                i.right.css({ left: o(e.x2), width: o(S - e.x2) }),
                i.left.css({ width: o(e.x) });
            }
            function s() {
              return e("<div />")
                .css({
            ...
            function c() {
              t ||
                ...
                j.hide(),
                u(r.shadeColor || r.bgColor, 1),
                G.isAwake() ? p(r.bgOpacity, 1) : p(1, 1));
            }
            function u(e, t) {
              Z(f(), e, t);
            }
            function d() {
              t &&
                ...
                (t = !1),
                G.isAwake()
                  ? G.setBgOpacity(r.bgOpacity, 1, 1)
                  : (G.setBgOpacity(1, 1, 1), G.disableHandles()),
                Z(T, 0, 1));
            }
            function p(e, i) {
              t &&
            ...
            return {
              ...
              disable: d,
              resize: function (e, t) {
                i.left.css({ height: o(t) }), i.right.css({ height: o(t) });
              },
              refresh: function () {
                r.shade ? c() : d(), G.isAwake() && p(r.bgOpacity);
              },
              opacity: p,
            };
          })(),
          G = (function () {
            ...
            function s() {
              var e = W.getFixed();
              W.setPressed([e.x, e.y]), W.setCurrent([e.x2, e.y2]), c();
            }
            function c(e) {
              if (t) return u(e);
            }
            function u(e) {
              ...
              !(function (e, t) {
                ...
                (a = n.x),
                (i = n.y),
                r.shade || j.css({ top: o(-i), left: o(-a) }),
                I.css({ top: o(i), left: o(a) }),
                r.shade && H.updateRaw(n),
                t ||
                  (function () {
            ...
            e.isArray(r.createHandles) &&
              (function (e) {
                var t;
                for (t = 0; t < e.length; t++) i[e[t]] = n(e[t]);
              })(r.createHandles),
              r.drawBorders &&
                e.isArray(r.createBorders) &&
                (function (t) {
                  var i, n, r, o;
          ...
          Y = (function () {
            ...
            function o(i) {
              return (
                ...
                R &&
                  ((R = !1),
                  a(c(i)),
                  G.isAwake() && r.onSelect.call($, h(W.getFixed())),
                  V.css({ zIndex: 290 }),
            ...
            return (
              i || V.mousemove(n).mouseup(o).mouseout(o),
              C.before(V),
              {
                activateHandlers: function (r, c) {
                  return (
                    (R = !0),
                    (t = r),
                    (a = c),
          ...
          X = (function () {
            var t = e('<input type="radio" />')
              ...
              a = e("<div />")
                ...
                .append(t);
            function i(e, t, a) {
              r.allowMove && (W.moveOffset([t, a]), G.updateVisible(!0)),
                e.preventDefault(),
                e.stopPropagation();
            }
            return (
        ...
        function Q(e) {
          r.allowResize
            ? e
              ...
              : G.enableHandles()
            : G.disableHandles(),
            G.setCursor(r.allowMove ? "move" : "default"),
            r.hasOwnProperty("trueSize") &&
              ((U = r.trueSize[0] / S), (B = r.trueSize[1] / F)),
            r.hasOwnProperty("setSelect") &&
              (J(r.setSelect), G.done(), delete r.setSelect),
            H.refresh(),
            r.bgColor != N &&
              (Z(
                r.shade ? H.getShades() : T,
                (r.shade && r.shadeColor) || r.bgColor
              ),
              (N = r.bgColor)),
            q != r.bgOpacity &&
              ((q = r.bgOpacity), r.shade ? H.refresh() : G.setBgOpacity(q)),
            (P = r.maxSize[0] || 0),
            (M = r.maxSize[1] || 0),
            (O = r.minSize[0] || 0),
            (E = r.minSize[1] || 0),
            r.hasOwnProperty("outerImage") &&
              (C.attr("src", r.outerImage), delete r.outerImage),
            G.refresh();
        }
        Q(!0);
        var $ = {
  ...
  var ba = /-\/crop\/([0-9]+)x([0-9]+)(\/(center|([0-9]+),([0-9]+)))?\//i,
              ...
              return (
                ...
                this.__api.setOptions({
                  aspectRatio: e.preferedSize
                    ...
                    : 0,
                  minSize: e.notLess
                    ? Ae(e.preferedSize, this.originalSize)
                    : [0, 0],
                })
              );
            },
            ...
            value: function (e) {
              ...
              return (
                ...
                this.crop.preferedSize &&
                  (i = Ae(this.crop.preferedSize, i, !0)),
                t
              ...
              return (
                ...
                (n = function () {
                  ...
                  for (
                    n = 0,
                      e = 0,
                      i = (t = r.dialogApi.fileColl.lastProgresses()).length;
                    e < i;
                    e++
                  )
                    n +=
                      ((null != (o = t[e]) ? o.progress : void 0) || 0) /
                      t.length;
                  return a.notify(n);
                }),
                ...
                n(),
                (t = new na(i).listen(a.promise())),
                this.dialogApi.progress(function () {
                  var e;
                  return (e = t).update.apply(e, arguments);
                })
              );
            },
          },
    ...
    xa = (function (t) {
      u(n, t);
      var i = m(n);
      function n(t, r, o, l, s) {
        var c;
        return (
          a(this, n),
          ((c = i.apply(this, arguments)).container = t),
          (c.tabButton = r),
          (c.dialogApi = o),
          (c.settings = l),
          (c.name = s),
          e.each(c.dialogApi.fileColl.get(), function (e, t) {
            return c.__setFile(t);
          }),
          c.dialogApi.fileColl.onAdd.add(c.__setFile.bind(f(c))),
          (c.widget = null),
          (c.__state = null),
          c
        );
        ...
        r(n, [
          {
            ...
            value: function (e) {
              ...
              return (
                ...
                (a = ce(this.__tryToLoadImagePreview.bind(this))),
                (i = ce(this.__tryToLoadVideoPreview.bind(this))),
          ...
          },
          {
            ...
            value: function (t, a) {
              ...
              return (
                ...
                "pending" !== t.state() ||
                !a.size ||
                a.size >= this.settings.multipartMinSize
                  ? i.reject().promise()
                  : (Qe(
                      a,
                      1550,
                      ...
                      .done(function (e, a) {
                        return Pe(e, "image/jpeg", 0.95, function (r) {
                          var o;
                          if (
                            (i.resolve(),
                            (e.width = e.height = 1),
                            ...
                            return (
                              (o = Q.createObjectURL(r)),
                              n.dialogApi.always(function () {
                                return Q.revokeObjectURL(o);
                              }),
                              "image" !== n.__state
          ...
          },
          {
            ...
            value: function (t, a) {
              ...
              return (
                (i = e.Deferred()),
                Q && a.size
                  ? ((n = Q.createObjectURL(a)),
                    He(n)
                      .fail(function () {
                        return Q.revokeObjectURL(n), i.reject();
                      })
                      .done(function () {
                        if (
                          "pending" === t.state() &&
                          ...
                          r.dialogApi.always(function () {
                            return Q.revokeObjectURL(n);
                          }),
                            i.resolve(),
                            r.__setState("video");
                          var e = r.container.find(
                            ".uploadcare--preview__video"
                          );
                          return (
                            e.on("loadeddata", function () {
                              return (
                                (e.get(0).currentTime = 36e4),
                                e.off("loadeddata")
                              );
                            }),
                            e.on("ended", function () {
                              return (e.get(0).currentTime = 0), e.off("ended");
                            }),
                            e.attr("src", n),
                            e.get(0).load()
                          );
          ...
          },
          {
            ...
            value: function (e, t) {
              (this.__state = e),
                ...
                this.container.empty().append(Qt("tab-preview-".concat(e), t)),
              ...
              if (
                ...
                (r = function () {
                  return (
                    ...
                    (o.widget = new ya(i, e, o.settings.crop[0])),
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                (i = t.children()),
                (a = "uploadcare--crop-sizes__item_current"),
                e.each(this.settings.crop, function (r, o) {
                  var l, s, c, u, d, p;
                  return (
                    (d = o.preferedSize)
                      ? ((s = se(d[0], d[1])),
                        (l = "".concat(d[0] / s, ":").concat(d[1] / s)))
                      : (l = Pt.t("dialog.tabs.preview.crop.free")),
                    (u = i
                      .clone()
                      .appendTo(t)
                      .attr("data-caption", l)
                      .on("click", function (i) {
                        "true" !== e(i.currentTarget).attr("aria-disabled") &&
                          !e(i.currentTarget).hasClass(a) &&
                          n.settings.crop.length > 1 &&
                          n.widget &&
                          (n.widget.setCrop(o),
                          t.find(">*").removeClass(a),
                          u.addClass(a));
                      })),
                    d
                      ? ((p = Ae(d, [30, 30], !0)),
          ...
          uploadcareMovable: function (t) {
            ...
            this.on(n, t.items, null, function (n) {
              if ((i(n), t.anyButton || 1 == n.which)) {
                ...
                var c = "mousemove.{} touchmove.{}".replace(/\{}/g, a);
                e(document).on(c, function (e) {
                  if (
                    (i(e),
                    !r &&
                    ...
                    var a = "y" == t.axis ? 0 : e.pageX - n.pageX,
                      c = "x" == t.axis ? 0 : e.pageY - n.pageY;
                    l.css({ left: a + s.left, top: c + s.top }),
                      t.move({ event: e, dragged: o, fake: l, dx: a, dy: c });
                  }
                });
                c = "mouseup.{} touchend.{} touchcancel.{} touchleave.{}";
                e(document).on(c.replace(/\{}/g, a), function (s) {
                  i(s);
                  if (
                    (e(document).off(
                    ...
                    s.preventDefault();
                    var c = s.pageX - n.pageX,
                      u = s.pageY - n.pageY;
                    (r = !1),
                      t.finish({ event: s, dragged: o, fake: l, dx: c, dy: u }),
                      t.keepFake || l.remove();
                  }
                });
              }
  ...
  var ka = (function (t) {
    ...
    function n() {
      ...
      return (
        a(this, n),
        (t = i.apply(this, arguments)).container.append(
          Qt("tab-preview-multiple")
        ),
        (t.__fileTpl = e(Qt("tab-preview-multiple-file"))),
        (t.fileListEl = t.container.find(".uploadcare--files")),
        (t.doneBtnEl = t.container.find(".uploadcare--preview__done")),
        e.each(t.dialogApi.fileColl.get(), function (e, a) {
          return t.__fileAdded(a);
        }),
        t.__updateContainerView(),
        t.dialogApi.fileColl.onAdd.add(t.__fileAdded.bind(f(t)), function () {
          return t.__updateContainerView();
        }),
        t.dialogApi.fileColl.onRemove.add(
          t.__fileRemoved.bind(f(t)),
          function () {
            return t.__updateContainerView();
          }
        ),
        t.dialogApi.fileColl.onReplace.add(
          t.__fileReplaced.bind(f(t)),
          function () {
            return t.__updateContainerView();
          }
        ),
        t.dialogApi.fileColl.onAnyProgress(t.__fileProgress.bind(f(t))),
        t.dialogApi.fileColl.onAnyDone(t.__fileDone.bind(f(t))),
        t.dialogApi.fileColl.onAnyFail(t.__fileFailed.bind(f(t))),
        t.fileListEl.addClass(
          t.settings.imagesOnly
      ...
      r(n, [
        ...
        },
        {
          ...
          value: function () {
            ...
            if (
              ...
              (i = Pt.t("dialog.tabs.preview.multiple.question").replace(
                "%files%",
                Pt.t("file", t)
              )),
              ...
              return (
                (o = r
                  ? Pt.t("dialog.tabs.preview.multiple.tooManyFiles").replace(
                      "%max%",
                      this.settings.multipleMax
                    )
                  : t && n
                  ? Pt.t("dialog.tabs.preview.multiple.tooFewFiles")
                      .replace("%min%", this.settings.multipleMin)
                      .replace("%files%", Pt.t("file", t))
                  : void 0),
        ...
        },
        {
          ...
          value: function (e, t) {
            var a;
            return (
              (a = t.name || Pt.t("dialog.tabs.preview.unknownName")),
              e.find(".uploadcare--file__name").text(a),
              e
                .find(".uploadcare--file__description")
                .attr(
                  "aria-label",
                  Pt.t("dialog.tabs.preview.multiple.file.preview").replace(
                    "%file%",
                    a
                  )
                ),
              e
                ...
                .attr(
                  "title",
                  Pt.t("dialog.tabs.preview.multiple.file.remove").replace(
                    "%file%",
                    a
                  )
                )
              ...
              e.find(".uploadcare--file__size").text(je(t.size, "–"))
            );
          },
        },
        {
          ...
          value: function (t, a) {
            ...
            return (
              ...
              a.isImage
                ? ((i = "".concat(
                  ...
                  this.settings.previewUrlCallback &&
                    (i = this.settings.previewUrlCallback(i, a)),
              ...
              n.find(".uploadcare--file__description").on("click", function () {
                return ja(t, l.settings).done(function (e) {
  ...
  w() &&
    e(window).on("keydown", function (e) {
      if (
        Sa() &&
        (27 === e.which &&
          (e.stopImmediatePropagation(), null != za && za.reject()),
        9 === e.which)
      )
        return (function (e) {
          return !e.shiftKey && Ca.last().is(e.target)
            ? (e.preventDefault(), Ca.first().focus())
            : e.shiftKey && Ca.first().is(e.target)
            ? (e.preventDefault(), Ca.last().focus())
            : void 0;
        })(e);
    });
  var za = null,
    ...
    Ta = function (t, a, i) {
      ...
      return (
        ...
        (r = e(Qt("dialog")).appendTo("body")),
        (o = Da(r.find(".uploadcare--dialog__placeholder"), t, a, i, {
          inModal: !0,
        })),
        r.find(".uploadcare--panel").addClass("uploadcare--dialog__panel"),
        r.addClass("uploadcare--dialog_status_active"),
        (o.dialogElement = r),
        (Ca = r.find("select, input, textarea, button, a[href]"))
          .first()
          .focus(),
        (n = (function (e, t) {
          var a, i;
        ...
        })(e(window), "absolute" === r.css("position"))),
        e("html, body").addClass("uploadcare--page"),
        r.find(".uploadcare--dialog__close").on("click", o.reject),
        r.on("dblclick", function (t) {
          var a;
          if (
            e.contains(document.documentElement, t.target) &&
            ((a =
              ".uploadcare--dialog__panel, .uploadcare--dialog__powered-by"),
            !e(t.target).is(a) && !e(t.target).parents(a).length)
          )
            return o.reject();
        }),
        (za = o.always(function () {
          return (
            e("html, body").removeClass("uploadcare--page"),
            (za = null),
            r.remove(),
            n(),
            Aa.focus()
      ...
      var r,
        ...
        l =
          arguments.length > 4 && void 0 !== arguments[4]
            ...
            : { inModal: !1 };
      return (
        e.isPlainObject(i) && ((n = i), (i = null)),
        a ? (zt(a) ? (a = a.files()) : e.isArray(a) || (a = [a])) : (a = []),
        (n = Ve(n)),
        (o = new Ma(n, t, a, i, l).publicPromise()),
        de(
          o,
          (r = function (e) {
            return n.multiple ? Rt(e, n) : e[0];
          }),
          r
        ).promise(o)
      );
  ...
  var Ma = (function () {
      function t(i, n, r, o, l) {
        ...
        a(this, t),
          ...
          (s = ".uploadcare--panel"),
          (this.content = e(Qt("dialog__panel"))),
          (this.panel = this.content.find(s).add(this.content.filter(s))),
          (this.placeholder = e(n)),
          this.placeholder.replaceWith(this.content),
          this.panel.append(e(Qt("icons"))),
          ...
          this.files.onRemove.add(function () {
            if (0 === c.files.length()) return c.hideTab("preview");
          }),
          this.__autoCrop(this.files),
          (this.tabs = {}),
          this.__prepareFooter(),
          (this.onTabVisibility = e.Callbacks().add(function (e, t) {
            return c.panel
      ...
      return (
        r(t, [
              ...
              return (
                this.promise ||
                  (this.promise = this.dfd.promise({
                    ...
                    onTabVisibility: he(this.onTabVisibility),
                  })),
                this.promise
              );
            },
                ...
                return e.autoThen(function (e) {
                  ...
                  return !e.isImage || e.cdnUrlModifiers || e.crop
                    ...
                    : ((t = e.originalImageInfo),
                      ...
                      Ce(e, n.settings.crop[0], [t.width, t.height], {
                        width: a[0],
                        height: a[1],
          ...
          },
          {
            ...
            value: function () {
              return (
                this.panel.replaceWith(this.placeholder), this.content.remove()
              );
            },
          },
          {
            ...
            value: function (t) {
              var a,
                ...
                o = this;
              if (!(t in this.tabs)) {
                if (!(a = Ia[t])) throw new Error("No such tab: ".concat(t));
                return (
                  (r = e("<div>")
                    .addClass("uploadcare--tab")
                    .addClass("uploadcare--tab_name_".concat(t))
                  ...
                  (i = e("<div>", { role: "button", tabindex: "0" })
                    .addClass("uploadcare--menu__item")
                    .addClass("uploadcare--menu__item_tab_".concat(t))
                    .attr("title", Pt.t("dialog.tabs.names.".concat(t)))
                    .append(n)
                    .appendTo(this.panel.find(".uploadcare--menu__items"))
                    .on("click", function () {
                      return t === o.currentTab
                        ? o.panel
                            .find(".uploadcare--panel__menu")
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                "empty-pubkey" === t && a.addClass("uploadcare--panel__icon"),
                e("<div>")
                  .addClass("uploadcare--menu__item")
                  .addClass("uploadcare--menu__item_tab_".concat(t))
                  .attr("aria-disabled", !0)
    ...
    Oa = (function () {
      function t(i, n) {
        ...
        a(this, t),
          ...
          (this.__onChange = e.Callbacks().add(function (e) {
            return null != e
              ? e.promise().done(function (e) {
                  return r.__onUploadComplete.fire(e);
                })
              : void 0;
          })),
          this.__setupWidget(),
          ...
          (this.__hasValue = !1),
          le(function () {
            if (!r.__hasValue) return r.reloadInfo();
          });
      }
      return (
        r(t, [
          {
            ...
            value: function () {
              var e,
                t = this;
              return (
                (this.template = new ha(this.settings, this.element)),
                (e = ["buttons.choose"]).push(
                  this.settings.imagesOnly ? "images" : "files"
                ),
                e.push(this.settings.multiple ? "other" : "one"),
                this.template
                  .addButton("open", Pt.t(e.join(".")))
                  .toggleClass("needsclick", this.settings.systemDialog)
                  .on("click", function () {
                    return t.openDialog();
                  }),
                this.template
                  .addButton("cancel", Pt.t("buttons.cancel"))
                  .on("click", function () {
                    return t.__setObject(null);
                  }),
                this.template
                  .addButton("remove", Pt.t("buttons.remove"))
                  .on("click", function () {
                    return t.__setObject(null);
                  }),
              ...
              if ((e = this.__currentFile()))
                return (
                  ...
                  e
                    ...
                    .fail(function (a) {
                      if (e === t.__currentFile())
                        return t.__onUploadingFailed(a);
                    })
                );
            },
          },
          ...
          },
          {
            ...
            value: function (e) {
              return this.__setObject(kt(e, this.settings));
            },
          },
          {
            key: "value",
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return this.settings.systemDialog
                ? Fe(this.template.content, this.settings, function (e) {
          ...
          },
          {
            ...
            value: function (e) {
              var t;
              return (
                (t = Ta(this.currentObject, e, this.settings)),
            ...
            value: function () {
              return (
                this.__api ||
                  ...
                  (this.__api.onChange = he(this.__onChange)),
                  (this.__api.onUploadComplete = he(this.__onUploadComplete)),
                  (this.__api.onDialogOpen = he(this.__onDialogOpen)),
    ...
    return (
      r(i, [
        ...
        },
        {
          key: "__setObject",
          value: function (e) {
            return Ct(this.currentObject, e)
              ? e
                ? void 0
                : (this.__reset(), this.element.val(""))
              : g(d(i.prototype), "__setObject", this).call(this, e);
          },
        },
        {
          key: "__setExternalValue",
          value: function (e) {
            var t,
              a = this;
            return (
              (this.__lastGroupPr = t = At(e, this.settings)),
              e &&
                (this.template.setStatus("started"),
                this.template.statusText.text(Pt.t("loadingInfo"))),
              t
                .done(function (e) {
        ...
        },
        {
          key: "__handleDirectSelection",
          value: function (e, t) {
            var a = wt(e, t, this.settings);
            return this.settings.systemDialog
              ? this.__setObject(Rt(a, this.settings))
              : this.__openDialog("preview").addFiles(a);
          },
        },
      ]),
  ...
  Ua._name = "MultipleWidget";
  var Ba = "uploadcareWidget",
    Ra = '[role~="uploadcare-uploader"]',
    La = function () {
      var t,
        a,
        i,
        ...
        l =
          arguments.length > 0 && void 0 !== arguments[0]
            ? arguments[0]
            : ":root";
      for (r = [], a = 0, i = (n = e(l)).length; a < i; a++)
        (t = n[a]), (o = Va(t.querySelectorAll(Ra))), (r = r.concat(o));
      return r;
    },
    Va = function (t) {
      var a, i, n, r, o;
      for (n = [], a = 0, i = t.length; a < i; a++)
        (r = t[a]),
          ((o = e(r).data(Ba)) && o.inputElement === r) || n.push(Wa(r));
      return n;
    },
    Na = function (e) {
      return Wa(e, Ea);
    ...
    Wa = function (t, a) {
      ...
      if (a && r !== a)
        throw new Error(
          "This element should be processed using ".concat(r._name)
        );
      var o = t.data(Ba);
      if (!o || o.inputElement !== t[0]) {
        Ha(t);
        var l = new r(t, n);
        (o = l.api()), t.data(Ba, o), l.template.content.data(Ba, o);
      }
      return o;
    },
    Ha = function (t) {
      return t.off(".uploadcare").each(function () {
        var t, a;
        if (
          (t = (a = e(this).next(".uploadcare--widget")).data(Ba)) &&
          t.inputElement === this
        )
          return a.remove();
      });
    ...
    Ga = ce(function (e, t) {
      if (((e = Le(e, t)), !t)) return e.live && setInterval(La, 100), La();
    });
  w() &&
    e(function () {
      window.UPLOADCARE_MANUAL_START || Ga();
    });
  var Ya = c(
      c({}, Ht),
      {},
      {
        templates: { JST: Zt, tpl: Qt },
        crop: { CropWidget: ya },
        dragdrop: {
          support: sa,
          uploadDrop: ca,
    ...
    Ja = c(
      ...
      {},
      {
        ...
        Widget: Ka,
        tabsCss: Kt,
        dragdrop: { receiveDrop: ua, support: sa, uploadDrop: ca },
      }
    ),
    Za = Gt(Ya);
  return c(
    c({}, Ja),
    {},
    { plugin: Za, locales: Object.keys(Pt.translations) }
  );
});
